...
#  1. Tuning hyperparameters of the random forest
# ------------------------------------------------------------------------------
...
# add the tuned random forest model to the list of models
...
models <- caretList(purchased ~ gender + age + city 
                    ...
                    trControl = trainControl(method = "boot",
                                             ...
                                             summaryFunction = twoClassSummary), # Using "defaultSummary" instead, will output Kappa and Accuracy.                     methodList = c('naive_bayes'),
                    tuneList = list(
                      rf.opt = caretModelSpec(method = "rf",
                                              tuneGrid = expand.grid(mtry=2:4)), #testing values 2 to 4
