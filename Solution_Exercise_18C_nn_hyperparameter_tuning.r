...
#  1. Tuning hyperparameters of the neural networks
# ------------------------------------------------------------------------------
...
models <- caretList(purchased ~ gender + age + city 
                    ...
                    tuneList = list(
                      nn.opt = caretModelSpec(method = "nnet",
                                              tuneGrid = expand.grid(size=1:20, decay=0)),
                      nn = caretModelSpec(method = "nnet"),
                      lr.opt = caretModelSpec(method = "LogitBoost",
                                              tuneGrid = expand.grid(nIter=3:15)),
